...
// All the numbers and operators input will be stored in an array "num" using function "sendValues()"
...
//Check if the first char is spl char, raise alert
...
function equalTo() {
	...
	console.log("Before eval func output" + b);
	...
	// console.log("Final ans" + num.push(ans.toString()));
